            ...
            <div className="col">
              <p className="mb-4">
                <span className="badge badge-primary ps-1">
                  <span className="badge badge-primary bg-white lh-sm">
                    FilFi联合节点
                  </span>
                  <span className="ms-2">
              ...
              <h1 className={classNames('mb-4 fw-600', styles.title)}>
                Filecoin首个100%<span className="text-danger">智能合约</span>
                管理的存储节点<span className="text-danger">联合建设</span>方案
              </h1>
              <p className={classNames('mb-4 mb-lg-5', styles.summary)}>
                履约交给智能合约，安心领取收益
              </p>
            ...
            <div className="col">
              <div className="card h-100">
                <div className="card-body">
                  ...
                  <p>
                    可选技术服务商经过社区严格的KYC，创新的“运维保证金”制度，确保技术服务商与建设者的短期利益和长期利益绑定。
                  </p>
                </div>
              </div>
            </div>
